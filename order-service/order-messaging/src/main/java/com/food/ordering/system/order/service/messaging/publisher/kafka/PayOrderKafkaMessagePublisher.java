...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            ...
            kafkaProducer.send(orderServiceConfigData.getRestaurantApprovalRequestTopicName(),
                    ...
                    getKafkaCallback(orderId, restaurantApprovalRequestAvroModel));
    ...
    private ListenableFutureCallback<SendResult<String, RestaurantApprovalRequestAvroModel>>
        getKafkaCallback(String orderId, RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel) {
        return orderKafkaMessageHelper.getKafkaCallback(
